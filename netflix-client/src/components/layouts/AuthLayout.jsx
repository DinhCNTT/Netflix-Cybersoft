...
const AuthLayout = () => {
  return (
    ...
    >
      ...
      {/* === Footer === */}
      <footer
        className="relative z-10 py-8 text-[13px] border-t border-[#404040]/30 sm:bg-black/75 bg-black"
      >
        <div className="mx-auto w-full max-w-[1000px] px-8 sm:px-16 text-[#A6A6A6]">
          <p className="mb-8 hover:underline cursor-pointer text-base">Bạn có câu hỏi? Liên hệ với chúng tôi.</p>
          <div className="grid grid-cols-2 gap-x-4 gap-y-4 sm:grid-cols-4">
            ...
            <Link to="#" className="hover:underline">Redeem Gift Cards</Link>
            <Link to="#" className="hover:underline">Buy Gift Cards</Link>
            
            <Link to="#" className="hover:underline">Ways to Watch</Link>
            ...
            <Link to="#" className="hover:underline">Only on Netflix</Link>
          </div>
